...
public class Q1 {
	...
	public Q1(String secret, int length, String algorithm)
	...
	public static void main(String[] args) {
		File dir = new File("D:\\AIT\\SEM2\\Distributed System\\workspace\\lab4\\cryptodir");
		File[] filelist = dir.listFiles();

		Q1 ske;
		try {
			ske = new Q1("!@#$MySecr3tPassw0rd", 16, "AES");
