...
public class Q2_ReadMessage {
	...
	public Q2_ReadMessage(String filename, String keyFile) throws Exception {
	...
	public static void main(String[] args) throws Exception{
		new Q2_ReadMessage("DataFiles/SignedData.txt", "KeyPairs/publicKey");
	}
}
